    ...
    if request.method == 'POST':# and 'save_changes' in request.POST:
        ...
        if form.is_valid():
            ...
            request.session['preferences'] = {
                ...
                'earliest_time': earliest_time if not (earliest_time is None or latest_time_val is None) else None,
                'latest_time': latest_time if not (earliest_time is None or latest_time_val is None) else None,
