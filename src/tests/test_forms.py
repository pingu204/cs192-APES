...
class TestUserAuthenticationForm(TestCase):
    ...
    def test_user_auth_form_username_valid(self):
        form = UserAuthenticationForm(
            data={"username": "testinguser", "password": "Authenticateme123"}
        )
    ...
    def test_user_auth_form_email_valid(self):
        form = UserAuthenticationForm(
            data={"username": "authenticate@gmail.com", "password": "Authenticateme123"}
        )
    ...
    def test_user_auth_form_wrong_data_username(self):
        form = UserAuthenticationForm(
            data={"username": "wronguser", "password": "Authenticateme123"}
        )
        self.assertFalse(form.is_valid())
        self.assertEqual(len(form.errors), 1)  ##
    ...
    def test_user_auth_form_wrong_data_email(self):
        form = UserAuthenticationForm(
            data={"username": "wrongemail@gmail.com", "password": "Authenticateme123"}
        )
        self.assertFalse(form.is_valid())
        self.assertEqual(len(form.errors), 1)  ##
    ...
    def test_user_auth_form_wrong_data_password(self):
        form = UserAuthenticationForm(
            data={"username": "authenticate@gmail.com", "password": "Wrongpassword123"}
        )
        self.assertFalse(form.is_valid())
        self.assertEqual(len(form.errors), 1)  ##
